          ...
          <div className="main__content">
            ...
            <Fade direction="up" triggerOnce>
              <p className="main__second">
                Наша компания основана на принципах инноваций, эффективности и
                клиентоориентированности, что делает нас предпочтительным
                выбором в сфере железнодорожных логистических решений.
              </p>
            </Fade>
